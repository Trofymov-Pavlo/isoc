...
const formattedContent = computed(() => {
  ...
  formatted = formatted
    .replace(/^(\d+\.\s.+)$/gm, '<h2 style="margin-top: 24px; margin-bottom: 16px; font-weight: 700;">$1</h2>')
    .replace(/^(Conclusion\s*:.*)$/gmi, '<h2 style="margin-top: 24px; margin-bottom: 16px; font-weight: 700;">$1</h2>')
