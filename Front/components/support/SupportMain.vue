...
.hero {
  background: radial-gradient(circle at 10% 10%, rgba(123, 92, 224, 0.15), transparent 35%),
    radial-gradient(circle at 90% 20%, rgba(255, 107, 107, 0.18), transparent 30%),
    #0f0b1b;
  color: #f4f1ff;
  padding: 32px;
  border-radius: 16px;
...
.card {
  ...
  border-radius: 14px;
  padding: 20px;
  box-shadow: 0 12px 32px rgba(15, 11, 27, 0.12);
...
.badge {
  background: linear-gradient(135deg, #2f0538, #7b5ce0);
  color: #fff;
  border-radius: 10px;
  padding: 8px 12px;
  font-weight: 700;
...
.amount-btn.is-active {
  border-color: #7b5ce0;
  background: linear-gradient(135deg, rgba(123, 92, 224, 0.12), rgba(123, 92, 224, 0.04));
  box-shadow: 0 10px 20px rgba(123, 92, 224, 0.15);
}
...
.method-pill.is-active {
  border-color: #7b5ce0;
  background: linear-gradient(135deg, rgba(123, 92, 224, 0.14), rgba(123, 92, 224, 0.06));
}
...
.submit {
  ...
  cursor: pointer;
  min-width: 240px;
  box-shadow: 0 12px 24px rgba(123, 92, 224, 0.18);
...
.submit:not(:disabled):hover {
  ...
  box-shadow: 0 16px 28px rgba(123, 92, 224, 0.22);
}
